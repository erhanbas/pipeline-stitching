function [paireddescriptor,curvemodel,unreliable,neigbors_used] = curvatureOutlierElimination(paireddescriptor,curvemodel,scopeloc,params,model)
...
if 0
    ...
    if 0; util.debug.vizCurveStats; end
