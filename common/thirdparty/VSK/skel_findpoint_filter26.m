function [num_ridge, ridge, ridge_pos] = skel_findpoint_filter26(voxel, DisMatrix, rows, cols, slices, th)
...
ridge=Filter26(voxel, DisMatrix, rows, cols, slices, th, contain);
