...
%
% Display the main menu of the toolbox.
%
% This file is from Camera Calibration Toolbox for Matlab (http://www.vision.caltech.edu/bouguetj/calib_doc/)
%
...
set(fig_number,'Units','points', ...
	...
	'Resize','off', ...
	'Name',title_figure, ...
'Position',[pos(1) pos(2)-100 fig_size_x fig_size_y], ...
